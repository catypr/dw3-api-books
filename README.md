...
## - POST /usuarios
Esse endpoint é resposável por cadastrar um novo usuário no banco de dados.
...
{
      "name": "Catarine Pereira",
      "email": "catarine@email.com",
      "password": "5678"
}
{
      "name": "Larissa Toyohasi",
...
Exemplo de resposta: Usuário cadastrado com sucesso.

#### Requisição Inválida! 409

Caso essa requisição aconteça, significa que o Usuário já está cadastrado.

Exemplo de resposta:

```
{
   "err": "Usuário informado já cadastrado."
}
```
